  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // Fetch products
        const productsResponse = await fetch('/api/products?farmer=me');
                  ...
                  {products.map((product) => (
                    <tr key={product._id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <Link href={`/dashboard/products/${product._id}/edit`} className="text-primary-600 hover:text-primary-900 mr-4">
                          Edit
                        </Link>
